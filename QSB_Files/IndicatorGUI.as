package QSB_Files
{
	...
	public class IndicatorGUI extends MovieClip
	{
		...
		function SetIndicators(e:Event):void
		{
			...
			indicators_desc.y = 130;
			indicators_desc.x = -600;
		...
		function SetDatabases(e:Event):void
		{
			...
			databases_desc.y = 190;
			databases_desc.x = -600;
		...
		function SetStartDate()
		{
			...
			//lbl.setStyle("TextFormat", myTextFormat);
			//lbl.textField.antiAliasType = "ADVANCED";
			lbl.text = "Start";
